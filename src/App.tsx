// Using local components instead of the package
import { DarkThemeToggle, Button, Card, Badge, Alert, Modal } from "./components";
      ...
      <div className="relative flex w-full max-w-5xl flex-col items-center justify-center gap-12">
        <div className="relative flex flex-col items-center gap-6">
          ...
          <div className="mt-4 flex items-center gap-2">
            <Badge color="success">Components Extracted</Badge>
            <Badge color="info">46 Components Available</Badge>
          </div>
        </div>
        ...
        <div className="relative w-full space-y-6">
          ...
          <Alert color="info" className="mb-4">
            <span className="font-medium">Info!</span> All components are now in your codebase at{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              ...
              <p className="font-normal text-gray-700 dark:text-gray-400">
                This card is using the extracted Card component from your local codebase.
              </p>
