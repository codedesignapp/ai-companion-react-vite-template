...
export const clipboardTheme = createTheme<ClipboardTheme>({
  button: {
    base: "inline-flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-3 hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800",
  ...
  withIcon: {
    ...
    icon: {
      defaultIcon: "h-4 w-4",
      successIcon: "h-4 w-4 text-primary-700 dark:text-primary-500",
    },
  },
  withIconText: {
    ...
    icon: {
      ...
      successIcon: "me-1.5 h-3 w-3 text-primary-700 dark:text-primary-500",
    },
    label: {
      base: "inline-flex items-center",
      defaultText: "text-xs font-semibold",
      successText: "text-xs font-semibold text-primary-700 dark:text-primary-500",
    },
  },
});
